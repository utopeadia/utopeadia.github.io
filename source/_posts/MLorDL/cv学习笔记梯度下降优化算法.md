...
![](https://image.aiwush.com/16311026980438.png)
...
![截屏2020-02-22下午5.05.19](https://image.aiwush.com/16311026980459.png)
...
![截屏2020-02-22下午5.08.40](https://image.aiwush.com/16311026980477.png)
...
* 通常目标函数==震荡严重==，在神经网络优化情况下（没有全局最优解），这种震荡反而有可能让它避免被套牢在一个局部最小值，而找到更好的==局部最优解==![截屏2020-02-22下午5.30.12](https://image.aiwush.com/16311026980501.png)
...
* 所有的参数使用同样的学习率并不合适
* 容易被套牢在马鞍点(Saddle point)![截屏2020-02-22下午5.47.27](https://image.aiwush.com/16311026980525.png)

### 马鞍点

在马鞍点处，梯度为0，但是不是最优解。不同算法有些能够逃离，有些不能逃离。

![截屏2020-02-22下午5.48.28](https://image.aiwush.com/16311026980556.png)

在这种马鞍点中，Adadelta较容易逃离，NAG、Rmsprop、Adagrad、Momentum都可以逃离，随机梯度下降法（SGD）无法逃离。

![截屏2020-02-22下午5.54.44](https://image.aiwush.com/16311026980601.png)
...
![截屏2020-02-22下午6.01.38](https://image.aiwush.com/16311026980653.png)

假设中心凹槽为曲面，那么最优值应该在中心位置：

如果不引入Momentum，那么训练过程中，移动方向会不断向两侧跳跃：

![截屏2020-02-22下午6.05.36](https://image.aiwush.com/16311026980711.png)

如果引入Momentum：

![截屏2020-02-22下午6.06.15](https://image.aiwush.com/16311026980789.png)

#### 为什么能达到这样的效果

将曲面画作山谷形状，理想情况下是蓝色曲线的路径：

![截屏2020-02-22下午6.07.14](https://image.aiwush.com/16311026980886.png)

但是在传统算法，那么运动的曲线为红色曲线。如果我们将每一个点按照参数方向进行分解：

![截屏2020-02-22下午6.09.02](https://image.aiwush.com/16311026980959.png)

在每一点都进行分解：

![截屏2020-02-22下午6.10.27](https://image.aiwush.com/16311026981024.png)
...
* $v_t = \gamma v_{t-1}+\eta \nabla _{\theta}J(\theta -\gamma v_{t-1})$
  ...
  $\theta = \theta - v_t$![截屏2020-02-22下午6.14.46](https://image.aiwush.com/16311026981099.png)
...
![截屏2020-02-22下午6.39.39](https://image.aiwush.com/16311026981178.png)

#### 实现方法

![截屏2020-02-22下午6.41.16](https://image.aiwush.com/16311026981237.png)

![截屏2020-02-22下午6.41.42](https://image.aiwush.com/16311026981297.png)

![截屏2020-02-22下午6.41.52](https://image.aiwush.com/16311026981359.png)

![截屏2020-02-22下午6.42.35](https://image.aiwush.com/16311026981424.png)

### RMSprop

与上面两种方法几乎一致，把过去结果乘0.9，当前结果乘0.1

![截屏2020-02-22下午6.45.35](https://image.aiwush.com/16311026981490.png)
...
![截屏2020-02-22下午6.49.04](https://image.aiwush.com/16311026981558.png)

![截屏2020-02-22下午6.49.43](https://image.aiwush.com/16311026981625.png)
...
* 增加随机噪声到梯度
  ...
  * 使得model可以找到新的局部最小值 ![截屏2020-02-22下午7.06.25](https://image.aiwush.com/16311026981702.png)

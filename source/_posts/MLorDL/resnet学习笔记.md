...
![img](https://image.aiwush.com/16311015088231.png)
...
![12378184-794fb005a6a4978c](https://image.aiwush.com/12378184-794fb005a6a4978c.webp)

现在假设我们需要更新参数 $b_1$ ，那么我们就要求出损失函数对参数 $b_1$ 的导数，根据链式法则，可以写成下面这样：

而对于激活函数，之前一直使用Sigmoid函数，其函数图像成一个S型，如下所示，它会将正无穷到负无穷的数映射到0~1之间：

![image-20201218120642367](https://image.aiwush.com/16311015088289.png)

![image-20201218120627064](https://image.aiwush.com/16311015088446.png)
...
![image-20201218120732716](https://image.aiwush.com/16311015088477.png)
...
![image-20201218120904526](https://image.aiwush.com/16311015088332.png)
...
利用链式规则，可以求得反向过程的梯度： ![截屏2021-10-31 下午8.35.19](https://image.aiwush.com/jie-ping20211031-xia-wu83519.png)
...
![image-20201218121437398](https://image.aiwush.com/16311015088391.png)

论文中给出了几种不同层次的网络结构，这里使用最简单的18层结构进行编码。

![image-20201218112703309](https://image.aiwush.com/16311015088418.png)

![img](https://image.aiwush.com/picgo12378184-794fb005a6a4978c.webp)

...
categories:
  - 开发笔记
permalink: /post/conda-basic-usage-method-2nkwdn.html
comments: true
toc: true
---
...
<span style="font-weight: bold;" class="bold">本教程全部命令操作均在CMD(win)、terminal(win)、终端(linux/Macos)中执行</span>
...
>   使用加号<span style="font-weight: bold;" class="bold">Create</span>创建环境，在右侧添加删除或者更新包即可使用。
